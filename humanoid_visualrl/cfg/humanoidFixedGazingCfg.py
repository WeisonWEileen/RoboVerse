...
"""Configuration for fixed gazing humanoid tasks."""
...
class BaseTableHumanoidTaskCfg:
    """Base class for fixed gazing humanoid tasks.
    ...
    # Camera configuration for gazing tasks
    from metasim.scenario.cameras import PinholeCameraCfg

    @configclass
    class CameraCfg:
        """Camera configuration for gazing tasks."""
        name: str = "camera_first_person"
        width: int = 128
        height: int = 96
    ...
    # Randomization for cube position in gazing tasks
    randomize_cube_y_range: float = 0.2
